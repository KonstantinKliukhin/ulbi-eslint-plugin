...
module.exports = {
  meta: {
    ...
    messages: {
      [INCORRECT_LAYER_IMPORT_ERROR_ID]: "Layer can't be imported from layer upper, pls follow this layers imports convention shared > entities > featured > widgets > pages > app"
    }
  },
